  ...
  const itineraryData = [
    {
      ...
      spots: [
        ...
        { name: '🧳 登機行李規定', text: '<b>【必須隨身】</b>行動電源、備用鋰電池、打火機(限1個)、筆電/相機等。<br><b>【必須託運】</b>大於 100ml 的液體/膏狀物/噴霧、刀剪類尖銳物、腳架。<br>※ 華航免費託運額度：每人 1 件 (23公斤)。手提行李：1 件 (7公斤)。' },
    ...
    },
    {
      ...
      spots: [
        ...
        { name: '🧳 登機打包提醒 (常犯錯誤！)', text: '<b>【必須託運 (視為液體/膏狀)】</b>布丁、果凍、蒟蒻、味噌、洗面乳、牙膏、明太子。<br><b>【必須隨身】</b>行動電源、備用鋰電池、打火機。<br>※ 水蜜桃、蘋果等生鮮蔬果，及肉類製品（含肉乾、含肉泡麵）<b>嚴禁帶回台灣！</b>' },
        { name: '🛍️ 台灣入境免稅額度', text: '<b>【菸酒】</b>酒類 1.5 公升 (不限瓶數，須滿18歲)；捲菸 200 支/1條 (須滿20歲，電子菸/加熱菸依最新法規為主)。<br><b>【一般物品】</b>總值新台幣 3.5 萬元為限。<br><b>【藥妝品】</b>非處方藥每種最多 12 瓶(盒)，合計不超過 36 瓶(盒)；隱形眼鏡單一度數最多 60 片，合計不超過 2 種度數。' },
