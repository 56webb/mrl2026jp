  ...
  const itineraryData = [
    ...
    },
    {
      ...
      spots: [
        ...
        { name: '🛍️ 台灣入境免稅額度', text: '<b>【菸酒】</b>酒類 1 公升（不限瓶數）；捲菸 200 支（1條）或雪茄 25 支或菸絲 1 磅（須年滿20歲）。<br><b>【一般物品】</b>總值新台幣 3.5 萬元為限。<br><b>【藥妝品】</b>非處方藥每種最多 12 瓶(盒)，合計不超過 36 瓶(盒)；隱形眼鏡單一度數最多 60 片，合計不超過 2 種度數。' },
